                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('banner.create') }}" class="btn btn-sm btn-dark">Create Banner</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach ($banners as $banner)
                                    <tr>
                                        <td>{{ $banner->id }}</td>
                                        <td>{{ $banner->title }}</td>
                                        <td><img src="{{ asset('images/' . $banner->image) }}" width="90"></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#exampleModal{{ $banner->id }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure to delete <span
                                                                class="text-red">{{ $banner->title }}</span> banner?
                                                        </div>
