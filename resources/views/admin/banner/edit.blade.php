                    ...
                    <form method="POST" action="{{ route('banner.update', $banner->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" cols="25" rows="10" value="{{ $banner->description }}">{{ $banner->description }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" placeholder="Enter link1"
                                    value="{{ $banner->link1 }}" name="link1" required>
                                @if ($errors->has('link1'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" placeholder="Enter link2"
                                    value="{{ $banner->link1 }}" name="link2" required>
                                @if ($errors->has('link2'))
