                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            ...
                            <a href="{{ route('clients.create') }}" class="btn btn-sm btn-dark">Create Client</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                            ...
                            <tbody>
                                @foreach ($clients as $client)
                                    <tr>
                                        <td>{{ $client->id }}</td>
                                        <td>{{ $client->name }}</td>
                                        <td><img src="{{ asset('images/' . $client->image) }}" width="90"></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#exampleModal{{ $client->id }}">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            Are you sure to delete <span
                                                                class="text-red">{{ $client->name }}</span> client?
                                                        </div>
