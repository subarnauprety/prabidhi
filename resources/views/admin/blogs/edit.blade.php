                    ...
                    <form method="POST" action="{{ route('blogs.update', $blog->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                                ...
                                <select name="blog_type_id" class="form-control" required>
                                    ...
                                    @foreach (App\Models\BlogType::latest()->get() as $type)
                                        <option value="{{ $type->id }}"
                                            @if ($type->id === $blog->blog_type_id) selected @endif class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" id="summernote" cols="30" value="{!! $blog->description !!}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="short_description" class="form-control" id="summernote" cols="10" value="{!! $blog->short_description !!}"
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" class="form-control" required>
                                    ...
                                    <option value="inactive" @if ($blog->status === 'inactive') selected @endif>Inactive
                                    </option>
                                </select>
                            </div>
